...
| [testing.md](testing.md) | How to verify a change: the harnesses, purity checks, budgets, the manual sweep | a harness moves, or a budget changes |
| [development.md](development.md) | Build, dev channel, editor setup, generated data, packaging, CI, releases | the toolchain or the pipeline changes |
...
One document per feature, covering that feature's invariants and internals. Each begins with an
**Invariants** section — read it before changing anything in that folder.
