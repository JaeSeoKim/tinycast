...
The temptation is codegen or `Codable` reflection. **Resist it.** The *explicit* omission of
...
`AGENTS.md` states the rule: *"Consent flags live on the owning store, never in `AppSettings`… an import
